...
public class CommonProxy
{
	...
	public void RegisterItemsAndBlocks()
	{
		...
		GameRegistry.registerItem(ModItems.angleIronCross, Strings.ANGLE_IRON_CROSS_NAME);
		GameRegistry.registerItem(ModItems.mirrorSupport, Strings.MIRROR_SUPPORT_NAME);
		GameRegistry.registerItem(ModItems.mirror, Strings.MIRROR_NAME);
		GameRegistry.registerItem(ModItems.lens, Strings.LENS_NAME);
		GameRegistry.registerItem(ModItems.highPressureIronWafer, Strings.HIGH_PRESSURE_IRON_WAFER_NAME);
		GameRegistry.registerItem(ModItems.ironWafer, Strings.IRON_WAFER_NAME);
		GameRegistry.registerItem(ModItems.silverWafer, Strings.SILVER_WAFER_NAME);
		GameRegistry.registerItem(ModItems.copperWafer, Strings.COPPER_WAFER_NAME);
		GameRegistry.registerItem(ModItems.temperedGlass, Strings.TEMPERED_GLASS_NAME);
		GameRegistry.registerItem(ModItems.copperSpool, Strings.COPPER_SPOOL_NAME);
		GameRegistry.registerItem(ModItems.silverSpool, Strings.SILVER_SPOOL_NAME);
		GameRegistry.registerItem(ModItems.adhesive, Strings.ADHESIVE_NAME);
		GameRegistry.registerItem(ModItems.sodiumNitrate, Strings.SODIUM_NITRATE_NAME);
